...
--
-- Host: localhost:3306
-- Generation Time: Nov 30, 2021 at 07:02 PM
...
(15, 3, 3, 5, '7'),
(16, 3, 4, 3, '18'),
(17, 3, 5, 2, 'The guy who made this test is really cool, 10/10 recommend being friends with him. also i am sending hate mail to anyone who doesn\'t read the paragraphs he worked EXTREMELY hard on'),
(18, 3, 6, 6, '10');
...
(23, 33, 14, '22232', '2021-10-16 13:24:05'),
(24, 34, 14, '33131', '2021-10-22 16:23:04'),
(25, 35, 14, '32333', '2021-11-04 01:11:35'),
(26, 36, 14, '22232', '2021-11-04 12:14:22'),
(27, 37, 14, '23222', '2021-11-04 12:23:19'),
(28, 38, 14, '22232', '2021-11-04 13:16:44'),
(29, 39, 14, '22322', '2021-11-04 13:26:48');
...
(33, 'mud', 'ahmad', 'ahmad.madhwala@gmail.com', '$2y$10$6SqPZTCoM/Jyn2grA7bCNugFaIh7nIY2q6M1U0.FqLqO9rMrjCO/2', '22232', 0, '2021-10-16 13:20:42'),
(34, '19dnie', 'Dorothy', 'nie.175@osu.edu', '$2y$10$sJydZakgPdj2Iueu2ieNCOw0svRbb/AH4YxtDGC/ttErXx7OtLseO', '33131', 0, '2021-10-22 16:19:27'),
(35, 'reynastillo', 'Andrea', 'anheffe@gmail.com', '$2y$10$.b1uoTiRczCHGvrSXd0aUOWOFYI2.5aqf2zf0xHNJcyrRAqkF2vWW', '32333', 0, '2021-11-04 01:08:21'),
(36, 'juliusjr7', 'Julius', 'julius.giavaguhni7@gmail.com', '$2y$10$RS7Ts0QNDSb2YKWQSHJx/OYOSrvl473NpzNGz7Nt6N9Xw.uFe71X.', '22232', 0, '2021-11-04 11:56:51'),
(37, 'Emily', 'Emily', 'johnson.8831@osu.edu', '$2y$10$NpX1kuteyyNpsrywoZPaAO01meIQ0SAoJxR/HtMkXXspisyN4qHlu', '23222', 0, '2021-11-04 12:10:14'),
(38, 'Sageklein', 'Sage', 'Sagesavan@gmail.com', '$2y$10$c1egLQNmVK3uT1wIk.xZLOMSXfxjP5jl.gIiOMZaj7pZGVSETffKi', '23332', 0, '2021-11-04 13:07:23'),
(39, 'roryklein', 'Rory', 'klein.691@buckeyemail.osu.edu', '$2y$10$lkiYlwDTstxphBZhwxuIJ.08GAUQGZjm1/sMotkqusTGWL7yRHHgO', '22322', 0, '2021-11-04 13:24:03'),
(40, 'FrankNom', 'FrankNom', 'bkingss@rambler.ru', '$2y$10$SKWbBP6qwkmrG4Nth3A3MODtgKqSH.M1VczRau064r7ZBHzK0aBrq', '00000', 0, '2021-11-17 23:38:02'),
(41, 'Kendrick46', 'Earlene', 'richarddegen@sbcglobal.net', '$2y$10$KmpcZWxyqC4ZNSkpZ2uh/.IQjNlEJy5L/RYfzPgn6PHkSacIqLv2a', '00000', 0, '2021-11-21 02:55:16'),
(42, 'Amina97', 'Brionna', 'smile6981@yahoo.com', '$2y$10$Hbo.5bSKnNYzVspaMTSseO9E2Ob9lXLYIkba8on8bFBeRbCrSDFVm', '00000', 0, '2021-11-26 12:43:53'),
(43, 'Hellen2', 'Reagan', 'philfisco@gmail.com', '$2y$10$8X4jVnYksyKoNje.QoS4ceumMTdda5dqdD2aspdTly7ONwT9bBTCG', '00000', 0, '2021-11-26 21:40:18');
...
--
ALTER TABLE `surveys_responses`
  MODIFY `localID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `surveys_taken`
--
ALTER TABLE `surveys_taken`
  MODIFY `surveyTakenID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tests_responses`
--
ALTER TABLE `tests_responses`
  MODIFY `localID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=577;

--
-- AUTO_INCREMENT for table `tests_taken`
--
ALTER TABLE `tests_taken`
  MODIFY `testTakenID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `users_general`
  MODIFY `userID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
